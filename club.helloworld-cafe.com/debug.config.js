...
var config = {
  ...
  // mongodb 配置
  db: 'mongodb://127.0.0.1:27017/it_par_debug',
  db_name: 'it_par_debug',


  session_secret: 'Nobyeam9', // 务必修改
  auth_cookie_name: 'it_par_debug',
  ...
  GITHUB_OAUTH: {
    ...
    callbackURL: 'http://localhost:3016/auth/github/callback'
  },

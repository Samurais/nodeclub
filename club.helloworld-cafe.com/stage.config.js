...
var config = {
  ...
  // mongodb 配置
  db: 'mongodb://127.0.0.1:27017/it_par_stg',
  db_name: 'it_par_stg',


  session_secret: 'ubEtEtOk', // 务必修改
  auth_cookie_name: 'it_par_stg',
  ...
  qn_access: {
    ...
    bucket: 'musa-hw-club-stg1',
    domain: 'http://musa-hw-club-stg1.qiniudn.com'
  },
